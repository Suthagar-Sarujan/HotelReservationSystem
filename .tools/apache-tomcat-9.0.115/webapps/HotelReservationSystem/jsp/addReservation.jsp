...
<div class="app-shell">
    <header class="topbar no-print">
        <div class="topbar-main">
            <div class="brand-block">
                ...
                <div class="brand">Guest Booking Intake</div>
                <div class="brand-sub">Create complete reservation records in one step</div>
            </div>
    ...
    <section class="page-header">
        ...
        <p class="page-subtitle">Capture guest profile, stay duration, and room type with validated booking details.</p>
    </section>
    ...
    <section class="grid-2">
        <article class="card">
            ...
            <p class="section-subtitle">Fill all required fields to generate a valid reservation record.</p>
        ...
        <aside class="card no-print">
            ...
            <ul class="help-list">
                <li>Confirm legal guest name and primary contact number.</li>
                <li>Verify check-out date is after the check-in date.</li>
                <li>Choose the correct room type before submitting.</li>
                <li>Record special requests for front desk coordination.</li>
            </ul>
        </aside>
    </section>
</div>
